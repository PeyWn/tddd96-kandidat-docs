...
Åtgärd: Om produkten inte skulle gå att köra på kundens datorer av någon anledning så får man lokalisera vad problemet är. Det mest troliga skulle vara om någon programvara saknas på datorerna. För att förhindra detta så ska gruppen ha med i kravspecifikationen vilka plattformar som kunden vill att produkten ska gå att köra på. Då förutsätter gruppen att kunden har den programvara som behövs installerad på plattformen.

\textbf{7. De olika verktg vi använder är inte kompatibla med varandra}\\
Åtgärd: Om gruppmedlemmar har arbetat med olika verktyg och de olika delarna inte skulle vara kompatibla med varandra när man slår ihop dem så kan detta ha stor påverkan på projektet. För att åtgärda detta så har utvecklingsansvarig ansvaret för att bestämma de verktyg som ska användas och undersöka under förstudien att dessa är kompatibla med varandra.
