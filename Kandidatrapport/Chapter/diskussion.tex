...
I början av projektet när gruppen skapades och projekt valdes så insåg gruppen att vi saknade en del kompetenser som behövdes för projektet. Det handlade om ett antal programspråk och ramverk som skulle användas. Sedan saknades kunskap om arbetssätt för versionshantering och grupparbeten i större projekt. Det som gruppens medlemmar fick ut av det var erfarenheten av att sätta upp en gå igenom en sort utbildningsfas. Det betyder att under de första veckorna så hade gruppen ett antal interna utbildnings moment. Det var allt ifrån programspråk så som html, css, TypeScript, JavaScript och LaTeX till arbetssätt för Git. Även utbildning i ramverket Angular och arbetsmetodiken Scrum ingick i fasen.

Det som gruppens medlemmar kan ta med sig av det är är något som vi tycker är viktigt och relevant för framtiden. Nämligen kunskapen och erfarenheten att sätta sig in i nya komplexa arbetssätt och metoder. Var av vissa är helt nya och andra strider mot gamla vanor. Att kunna göra sådana stora förändringar och ta in så mycket ny kunskap är mycket av vad som är vickigt då en ingenjör aldrig egentligen slutar lära och anpassa sig.

Så klart så var inte våran utbildningsfas felfri och plågades av oerfarenhet om hur man ska strukturera och planera en sådan. En direkt effekt av det var att vissa moment missades och att andra täcktes bra av teorin men saknade en praktisk sida. Alla dessa misstag och lärdomar gör att vi tillsammans har lärt oss otroligt mycket om vad det innebär att komma mer eller mindre blank till ett projekt.

Utöver detta så får man ett nytt perspektiv på projektarbeta när det inte finns någon annan som tillhandahåller material som säkerställer att projektet lyckas. Detta är mycket vanligt i universitetssammanhang och att få uppleva fira händer och känna att man klara av det så känns det väldigt bra.
