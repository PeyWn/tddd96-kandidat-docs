...
Den här gruppen la till sin början sitt fokus på att utveckla den grafiska designen. Som utgångspunkt för detta så fanns den pappersprototyp som hade gjorts. I takt med att utformningen av designen skapades så impelmenterades även de komponenter och den logik som skulle ingå i gränssnittet. Uppgifterna delades upp där man jobbade antingen i par eller enskilt.        
