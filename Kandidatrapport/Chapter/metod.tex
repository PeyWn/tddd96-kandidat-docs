...
Under projektets gång så har gruppens erfarenheter sammlats in på främst två sätt. Dels genom att dela erfarenheter relaterade till kunskap innom gruppen vid de olika presentationer som medlemarna haft för varandra och dels genom att regelbundet utvärdera arbetet som skett. Båda dessa metoder har använts för att sprida erfarheter och kunskap till hela gruppen. 
Efter som det projektgruppen har varit relativt lite så har detta också skett genom att alla har behövt jobba med många olika delar av projektet.
