...
Den produkt som har skapats är ett lättöverskådligt schemaläggningssystem för operationer. Produkten tillsammans med design och utvecklingen av den kommer att ha ett stort värde för kunden. Detta eftersom projektet på ett sätt kommer att användas som en form av förstudie till ett större projekt (se stycke \ref{sec:syfte}).


Det medför att Region Östergötland kommer att ha något att utgå ifrån då deras projekt går av stapeln, vilket hjälper mycket av flera anledningar. Kanske framförallt för projektägaren som också är insatt i det större projektet eftersom han kommer att kunna ta med sig många erfarenheter får det här projekt.
