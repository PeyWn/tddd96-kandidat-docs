...
Applikationen består av flera olika vyer, där vissa av vyerna skulle visas upp i samma behållare men vid olika tillfällen, beroende på vilken vy användaren för stunden är intresserad av. För att byta mellan vyerna användes Angulars tjänster. Tjänsterna är inte direkt kopplade till någon specifik komponent och kunde därför användas för att kommunicera mellen komponenter i olika delar av komponenthierarkin.

All den data om patienter, salar och utrustning som användaren var intresserad av fanns på en server i projektets back-end. Därför var det nödvändigt med kommunikation mellan de båda delarna. På projektets front-end sköttes kommunikationen med AJAX-begäranden. Dessa begäranden skedde i tjänster för att de skulle vara tillgängliga för alla kompononenter som behövde tillgång till data av olika sorter.    
