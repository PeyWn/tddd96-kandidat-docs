...
Arbetsflödet i appen börjar med att användaren loggar in med sin använare. Därefter presenteras vyn som visas i figur \ref{fig:window}.
...
Längst ner finns det även en ruta med sökkreterier för att filtrera den schemavy som visas i huvudfönstret så att en ledig tid kan hittas.
\begin{figure}[H]
	\centering
...
\subsubsection{Informationsbaren}
Informationsbaren är till för att alltid visa information om den patient som för tillfället håller på att bokas in. Så snart ett beslut har valts i sidopanelen så visas patientens namn och personnummer i infobaren.

I informationsbaren syns det också vilken användare som är inloggad längst till höger och det finns även en knapp för att logga ur aktuell användare.
