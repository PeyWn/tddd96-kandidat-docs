...
Det medför att Region Östergötland kommer att ha något att utgå ifrån då deras projekt går av stapeln, vilket hjälper av flera anledningar. Kanske framförallt för projektägaren som också är insatt i det större projektet eftersom han kommer att kunna ta med sig många erfarenheter från det här projekt.
