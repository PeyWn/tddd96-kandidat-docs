...
\section{Webstorm}
WebStorm är en utvecklingsmiljö för JavaScript och webbutveckling. Den har även stöd Html, Css och kompilerade språk som TypeScript. Till dessa språk finns smidiga hjälpfunktioner som kodkomplettering, kraftfull navigering, feldetektering i realtid och refaktorering. Den har även stöd ich hjälp för Node.js och  och för web, JavaScript och TypeScript utveckling. WebStorm innehåller flera smidiga funktioner såsom kodkomplettering, API-dokumentation och inbyggt stöd för versionshantering. \cite{webstorm}
