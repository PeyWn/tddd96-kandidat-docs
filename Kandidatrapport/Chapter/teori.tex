...
\section{Node.js}
Node.js är en asynkron och händelse-driven körmiljö som tillåter körning av JavaScript-kod utanför webbläsare. Node är designat för att skapa skalbara nätverksapplikationer men används också till annat som till exempel ramverket Angular.\cite{nodejs}
