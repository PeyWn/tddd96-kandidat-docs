...
\subsection{Intervjuer}
I denna sektion presenteras resultaten från den intervjudersökning som genomfördes på övriga gruppmedlemmar.

Alla medlemmar som intervjuades hade svaga eller inga kunskaper inom både JavaScript och TypeScript från innan projektet. Av de fem som intervjuades hade alla fått använda sig av TypeScript under projektet. När det kom till JavaScript skilde det sig något men alla hade i alla fall kommit i kontakt med språket under projektet.
\subsubsection{Hitta fel}
Från frågorna 1 och 2 i intervjun (se tabell \ref{henrik_fragor}) som handlade om detektering av fel erhölls blandade erfarenheter. 

nej räcker med bra kommunikation, ett par gånger, inte något jag märkt, ett par gånger, ja ide:n klagat några gånger

kanske små fel, hade nog hänt felstavning, lite färre typfel men enhetstester kan ersätta, fel argument till funktion, något iden håller i handen 
\subsubsection{Kodförståelse}
