...
1  & \begin{tabular}[c]{@{}c@{}}Hur ofta hjälpte typsystemet i TypeScript dig att undvika\\ fel i koden vid skrivning eller kompilering?\end{tabular}      & Ofta, Ibland, Aldrig                                                                                                \\ \hline
...
3  & \begin{tabular}[c]{@{}c@{}}Hur mycket hjälpte klasser och typsättning av variabler och funktioner\\ dig att förstå andra medlemmars kod?\end{tabular} & Ingenting, Liten hjälp, Stor hjälp                                                                                  \\ \hline
4  & \begin{tabular}[c]{@{}c@{}}Påverkade den extra typsättningen i TypeScript din\\ produktivitet i utvecklingen?\end{tabular}                            & \begin{tabular}[c]{@{}c@{}}Hade varit produktivare utan, Ingen skillnad,\\ Hjälpte med produktiviteten\end{tabular} \\ \hline
