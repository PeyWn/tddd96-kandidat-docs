...
Om en produkt eller tjänst har en positiv inverkan på de tre huvudområdena hållbar utveckling fokuserar på så kan den enligt ”ISO/IEC TR 29110-5-1-3” \citep{ISOtor} anses vara av högkvalitativa mått.  Denna ISO (standardisering) fokuserar på: 
...
Som den oerfarna  grupp vi var kunde TSLint och Angular tillsammans ledsaga oss tilt att tillsammans hålla den kodstandard som behövdes för att arbeta i ett större projekt. 
...
Ett mindre mjukvaruprojekt likt Aeon, där expertiskunskap saknas och kunskapsnivån är begränsad kan ha oerhörd nytta av kvalitetsförsäkrande ramverk och arbetsmetoder som TSLint och Angular. 
