...
På en operationsavdelning så utförs många olika ingrepp som kräver många olika sorters kompetenser, utrustning och material. För att organisera upp detta arbete så sitter idag en person och schemalägger de olika operationer som ska genomföras för att se till att resurser finns tillgängligt, att operationen har lokaler att vistas i och att den operation med högst brådskandegrad får högst prioritet. All denna information är mycket för en person att hålla koll på och det kan leda till att en operation inte kan utföras för att alla behov inte är tillgodosedda till operationstillfället eller att operationssalar står tomma.
...
Det är även olika uppsättningar verktyg och specialutrustning för olika operationer.
