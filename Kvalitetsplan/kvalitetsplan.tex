...
\section{Inledning}
\label{sec:Inledning}
Detta dokument beskriver kvalitetsarbetet i projekt att skapa ett schemaläggnignsstöd för kirurgi till Region Östergötland.
\subsection{Syfte}
...
För mjukvaruresurser se detta dokument, sektion 2.3.
