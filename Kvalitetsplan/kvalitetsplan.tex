...
Se sektionen 'Riskhantering' i Projektplanen.
...
Varje dag gruppen möts hålls en snabb genomgång om vad som har åstakommits sen senaste mötet samt vad som skall presteras till nästkommande. Möjliga hot mot prestationer presenteras.
...
För att på ett så entydigt sätt som möjligt klarlägga vad projektet har för standard så har en kravspecifikation utformats tillsammans med kund, se dokumentet Kravspecifikation.
...
Se projektplan avsnitt 'Kunskap och färdigheter'.
...
Två kvalitetsmätningar skall hållas efter varje sprint för att värdera kvalitéen hos arbetsmetodik samt resulterande produkt. 
...
När en arbetsuppgift bedömts att ej uppfylla de krav som specificerats i kravspecifikationen behöver uppgiften upprepas med en lämpligare arbetsmetod i en senare sprint. Se avsnitt 'Aktiviteter' i projektplanen samt sektion \ref{sec:Scrum} om Scrum i detta dokument.

\subsection{Risker med kvalitetssäkring av programvara}
Att följa denna kvalitetsplan medför de kända risker presenterade i avsnittet 'Riskhantering' i projektplanen. En risk är att kvalitetsplanen följs för febrilt, vilket kan medföra att frågan “Hur mycket får kvalitét kosta?” behöver ställas. Ansvaret att ställa denna fråga ligger på samtliga projektmedlemmar men främst på kvalitetssamordnare.
