...
\subsection{Angular}
Då kunden sedan tidigare använt sig av Angular beslutade projektgruppen sig för att också göra det. Arkitekturen för Angular lämpar sig väl till att utveckla en webbapplikation enligt designmönstret MVC.

\subsection{MySQL med JSON-API}
Eftersom data till databasen levereras i tabellform togs beslutet att lagra den i en SQL-databas. Då JSON-filer är enklare att arbeta med i javascript beslutades det även att klienten skulle kommunicera med databasen via ett API som översätter datan till JSON-format.
