...
\subsection{Syfte}
Arkitekturdokumentet ger en översikt av schemaläggningssystemets arkitektur. I dokumentet presenteras arkitekturen samt en översiktlig beskrivning av systemet och dess funktionalitet. Här går det även att utläsa vilka arkitektuellt signifikanta beslut som fattats och varför.
...
\begin{tabular}{|c|c|c|}
  \hline
  Kravtitel & Kravbeskrivning & Betydelse \\
  \hline
  Krav \ref{krav-subsec:Hognivasprakkrav} & Klienten ska använda sig av Angular och TypeScript. & Medför begränsningar för hur klienten kan implementeras. \\
  \hline
  Krav \ref{krav-subsec:EG-Mjukvarugranssnitt} & Klienten ska kunna köras på Internet Explorer 11. & Arkitekturen måste anpassas att fungera på en äldre webbläsare.
  \\
  \hline
...
Systemet skall användas av erfarna operationsplanerare som tidigare arbetat med schemaläggning.
...
\subsection{Model-view-controller}
Designmönstret MVC för användargränssnitt möjliggör separation av hur gränsnittets data lagras i systemet från sättet datan visas upp grafiskt för användare. Designmönstret delar upp gränssnittet i tre delar, Model, View och Controller (referens till https://en.wikipedia.org/wiki/Model-view-controller). Delarna beskrivs i större detalj nedan:
\begin{itemize}
