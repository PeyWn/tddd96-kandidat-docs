...
\section{Moduler}
Systemet är uppdelat i två delar, webbservern och webbklienten. Dessa delarna är i sin tur uppdelade i ett antal olika moduler. En övergripande systemskiss finns i arkitekturdokumentet under rubrik \ref{arki-sec:Systemskiss}. Mer information
angående webbklienten och dess moduler se sektion \ref{arki-sec:webbklient} medan information angående webbservern finns under sektion \ref{arki-sec:webbserver}.
...
\textbf{TestID:} \ref{sec:Boka Operation} \todo{added}
\\ \textbf{Tidpunkt:}
...
\textbf{TestID:} \ref{sec: Boka sal} \todo{added}
\\ \textbf{Tidpunkt:}
...
\textbf{TestID:} \ref{sec: Avboka sal} \todo{added}
\\ \textbf{Tidpunkt:}
\\ \textbf{Syfte och funktion:} Ska vara möjligt att avboka en bokad lokal.
  
\textbf{TestID:} \ref{sec: Inloggning} \todo{added}
\\ \textbf{Tidpunkt:}  
\\ \textbf{Syfte och funktion:} Det ska gå att logga in i systemet med ett giltigt lösenord.
  
\textbf{TestID:} \ref{sec: Tidlinje för operation} \todo{added}
\\ \textbf{Tidpunkt:}
\\ \textbf{Syfte och funktion:} Visa tillgänglig beslutsdata

\textbf{TestID:} \ref{sec: Översikt av beslutade operationer} \todo{added}
\\ \textbf{Tidpunkt:}  
\\ \textbf{Syfte och funktion:} Presentera belutade operationer.

\textbf{TestID:} \ref{sec: Schemaöversikt för planerade operationer} \todo{added}
\\ \textbf{Tidpunkt:}  
...
\textbf{Syfte:} Två stycken acceptanstest ska genomföras. Ett test ska utföras på systemets grafiska gränssnitt.  Det andra testet ska utföras på hela systemet efter att systemtester blivit godkänt.
...
\textbf{Utförande:} Testet ska utföras av hela projektgruppen. Gruppen utser två till tre personer som skapar en testspecifikation utifrån beskrivningen i testspecifikationsmallen. När det är klart så utför personerna testet enligt specifikationen \cite{kravspec}. Ett protokoll ska föras enligt mallen för testprotokoll, se testprotokoll-mall dokumentet. Om några problem uppstod som inte kunde lösas på plats ska dessa föras in under \emph{issues} i projektets
gitlab.
