...
\section{Moduler}
Systemet är uppdelat i två delar, webbservern och webbklienten. Dom här delarna är i sin tur är uppdelade i ett antal olika moduler. En övergripande systemskiss finns i arkitekturdokumentet under rubrik \ref{arki-sec:Systemskiss}. Mer information angående webbservern och dess moduler se sektion \ref{arki-sec:webbklient} medans information angående webbservern finns under sektion \ref{arki-sec:webbserver}.
