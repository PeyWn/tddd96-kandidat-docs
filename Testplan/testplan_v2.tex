...
Testerna är till för att säkerhetsställa att det som levereras uppfyller de krav som finns i Kravspecifikation sektion \ref{krav-sec:Specifika krav}.
...
Se kravspec \ref{krav-subsubsec:Planeringsvy} för mer ingående information om kraven som berör funktionen.
