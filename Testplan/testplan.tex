...
Syftet med denna testplan är att beskriva de tester som kommer att utföras. Målet är att dokumentera de tester som kommer att utföras för att säkerhetsställa systemets kvalite som finns beskrivet i dokumentet Kvalitetsplan samt de krav som finns beskrivet i dokumentet Kravspec. Då Scrum är vald som arbetsmetodik så kommer det att vara tester på varje testnivå.
