...
och innovation vid region östergötland, härdanefter benämd som kunden eller RÖ.
...
kraven.
\item Del~\ref{sec:Specifika krav} besrkiver kraven i detalj.
\item Efter del~\ref{sec:Specifika krav} finns en ordlista över begrepp och
förkortningar.
\item I appendix~\ref{sec:Ingaende data till systemet} finns en beskrining
...
\label{sec:overall}
I denna delen kommer kraven beskrivas övergripande och i ett kontext för att
...
Clienten kommer att användas på en vanlig PC. Servern kommer under utvecklingnen
att köras på vanliga PC men kan om någon form av småskalig distibution sker
...
för varje organization som systemet ska hantera.
...
från flera olika system och källor. Användaren har vana i att arbeta i
sjukhusets
...
Klienten ska gå att interagera i med hjälp av:
\begin{itemize}
  \item En mus
