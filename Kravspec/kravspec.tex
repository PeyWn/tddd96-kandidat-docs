...
\externaldocument[kval-]{../Kvalitetsplan/kvalitetsplan}
\begin{document}
...
\item De grafiska komponenterna ska uppnå ett snittbetyg på 3,8 i det användbarhetstest som defineras i testplanen.
\end{enumerate}
